...
//LEVEL 3
#define SETTINGS_CLOCK_HOURMINUTE 0
#define SETTINGS_CLOCK_SECONDS 1
#define SETTINGS_CALENDAR_DAYMONTH 2
#define SETTINGS_CALENDAR_YEAR 3


//DISPLAY DOTS
#define INTER_COLON 1
#define INTER_DOT 0
#define INTER_DISABLED DOT_DISABLED
