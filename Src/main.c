...
volatile uint8_t flagContactVibrations;
/* USER CODE END PV */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	LEDinit(&display, DISP_0_GPIO_Port, DISP_0_Pin, DISP_1_GPIO_Port, DISP_1_Pin,
	...
	//												MENU ITEMS CONFIG
	menuItemInit(&menu, CLOCK, 0, 0, NONE);
	menuItemInit(&menu, BAROMETER, 1, 0, NONE);
	menuItemInit(&menu, HIGROMETER, 2, 0, NONE);
	menuItemInit(&menu, TEMPERATURE, 3, 0, NONE);
	menuItemInit(&menu, ALTITUDE, 4, 0, NONE);
	menuItemInit(&menu, AZIMUTH, 5, 0, NONE);
	menuItemInit(&menu, CHRONO, 6, 0, NONE);
	menuItemInit(&menu, SETTINGS, 7, 0, NONE);

	//												MENU ITEMS VALUES
	menuItemChangeValue(&menu.items[CLOCK], "1210");
	menuItemChangeValue(&menu.items[BAROMETER], "1023");
	menuItemChangeValue(&menu.items[HIGROMETER], "38 H");
	menuItemChangeValue(&menu.items[TEMPERATURE], "20 ^");
	menuItemChangeValue(&menu.items[ALTITUDE], "123 ");
	menuItemChangeValue(&menu.items[AZIMUTH], "340 ^");
	menuItemChangeValue(&menu.items[CHRONO], "0000");
	menuItemChangeValue(&menu.items[SETTINGS], "SE");
...
//		LEDint(&disp1, 0, counter, LED_TRANSITION_DISABLED);
...
void encoderAction(uint8_t direction) {
	if (direction == ENCODER_ACTION_LEFT) {
		...
		switch (currentItem) {
		case 1:
			LEDstr(&display, 0, item1, LED_TRANSITION_DIR_LEFT);
			LEDdot(&display, 1);
			break;
		case 2:
			LEDstr(&display, 0, item2, LED_TRANSITION_DIR_LEFT);
			LEDdot(&display, DOT_DISABLED);
			break;
		case 3:
			LEDstr(&display, 0, item3, LED_TRANSITION_DIR_LEFT);
			LEDdot(&display, DOT_DISABLED);
			break;
		case 4:
			LEDstr(&display, 0, item4, LED_TRANSITION_DIR_LEFT);
			LEDdot(&display, DOT_DISABLED);
			break;
		case 5:
			LEDstr(&display, 0, item5, LED_TRANSITION_DIR_LEFT);
			LEDdot(&display, DOT_DISABLED);
			break;
		case 6:
			LEDstr(&display, 0, item6, LED_TRANSITION_DIR_LEFT);
			LEDdot(&display, DOT_DISABLED);
			break;
		}
	}
	if (direction == ENCODER_ACTION_RIGHT) {
		...
		switch (currentItem) {
		case 1:
			LEDstr(&display, 0, item1, LED_TRANSITION_DIR_RIGHT);
			LEDdot(&display, 1);
			break;
		case 2:
			LEDstr(&display, 0, item2, LED_TRANSITION_DIR_RIGHT);
			LEDdot(&display, DOT_DISABLED);
			break;
		case 3:
			LEDstr(&display, 0, item3, LED_TRANSITION_DIR_RIGHT);
			LEDdot(&display, DOT_DISABLED);
			break;
		case 4:
			LEDstr(&display, 0, item4, LED_TRANSITION_DIR_RIGHT);
			LEDdot(&display, DOT_DISABLED);
			break;
		case 5:
			LEDstr(&display, 0, item5, LED_TRANSITION_DIR_RIGHT);
			LEDdot(&display, DOT_DISABLED);
			break;
		case 6:
			LEDstr(&display, 0, item6, LED_TRANSITION_DIR_RIGHT);
			LEDdot(&display, DOT_DISABLED);
			break;
		}
