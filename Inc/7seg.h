...
#if LED_FIELDS == 1
#define LED_MAX_NUMBER 9
#endif

#if LED_FIELDS == 2
#define LED_MAX_NUMBER 99
#endif

#if LED_FIELDS == 3
#define LED_MAX_NUMBER 999
#endif

#if LED_FIELDS == 4
#define LED_MAX_NUMBER 9999
#endif
...
#define LED_DOT_DISABLED LED_FIELDS

#if LED_FIELDS >= 1
#define LED_FIELD_0 0
#endif
#if LED_FIELDS >=2
#define LED_FIELD_1 1
#endif
#if LED_FIELDS >= 3
#define LED_FIELD_2 2
#endif
#if LED_FIELDS >= 4
#define LED_FIELD_3 3
#endif
